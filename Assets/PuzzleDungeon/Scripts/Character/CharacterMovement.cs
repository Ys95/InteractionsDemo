...
namespace PuzzleDungeon.Character
{
    ...
    public class CharacterMovement : CharacterComponent, IInputReceiver
    {
        ...
        private void GroundCheck()
        {
            ...
            var touchingGround = Physics.SphereCast(center, radius, Vector3.down, out var hitInfo, distance, groundLayer, QueryTriggerInteraction.Ignore);
        ...
        /// <summary>
        /// Gradually reduce velocity when players stops
        /// </summary>
        ...
        private void Move()
        {
            _velocity = _velocity.ClampVector3(maxAbsoluteVelocity * -1, maxAbsoluteVelocity);
        ...
        {
            input.P_MovementVector2.E_ValueUpdated += SetMovementVector;
